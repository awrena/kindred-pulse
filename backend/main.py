...
def seed_data():
    ...
    posts = [
        ...
        Post(
            ...
            image_url="/meme.jpeg",
            post_type="meme",
            reactions=json.dumps({"🍪": 128, "🌶️": 64, "🍹": 42}),
        ),
    ]
    db.add_all(posts)
    ...
    events = [
        Event(
            ...
            description="Zamawiam kawę! Kto dołącza?",
            event_type="coffee",
        ...
        Event(
            ...
            title="Słodki Grzesiek",
            description="Guba częstuje Grześkami! Mega porcja czekoladowych wafelków czeka w kuchni.",
            event_type="cake",
            location="Kuchnia, Level 2",
            vibe="Sweet & Chill",
            starts_at=now + timedelta(minutes=15),
            capacity=10,
            image_url="/grzesiek.jpeg",
        ),
        Event(
            creator_id=users[1].id,
            title="Planszóweczki",
            description="Dominika zaprasza na wieczór planszówek! Mamy Catan, Dixit i Monopoly.",
            event_type="darts",
            location="Strefa Chill, Level 1",
            vibe="Fun & Games",
            starts_at=now + timedelta(hours=1),
            capacity=6,
            image_url="/dominika.jpeg",
        ),
        Event(
